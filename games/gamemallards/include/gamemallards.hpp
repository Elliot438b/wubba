...
public:
    ...
    ACTION playerbet(uint64_t tableId, name player, asset betDealer, asset betPlayer, asset betTie, asset betDealerPair, asset betPlayerPair, name agent, name spreadAccount, string nickname);
...
private:
    ...
    struct player_bet_info
    {
        ...
        asset spreadaccountcommission;

        EOSLIB_SERIALIZE(player_bet_info, (player)(betDealer)(betPlayer)(betTie)(betDealerPair)(betPlayerPair)(pBonus)(dBonus)(agent)(spreadAccount)(nickname)(playercommission)(agentcommission)(spreadaccountcommission))
    };
    ...
    TABLE table_stats
    {
        ...
        double commission_rate_player_spread;
        bool upgradingFlag;
        string redundancy;
        string redundancy1;
        // ------------------------------ round field ------------------------------
