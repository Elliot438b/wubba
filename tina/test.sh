...
cleos --wallet-url http://127.0.0.1:6666 push action useraaaaaaaj tesexransfer '[]' -p useraaaaaaaj

cleos --wallet-url http://127.0.0.1:6666 push action useraaaaaaaj testdispatch '["1.0000 SYS"]' -p useraaaaaaaj
