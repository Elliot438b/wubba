...
tableid=`cleos get table useraaaaaaaa useraaaaaaaa tablesinfoqq -l 100|grep tableId|awk -F' ' 'END {print $NF}' |awk -F ',' '{print $1}'`
...
cleos get table useraaaaaaaa useraaaaaaaa tablesinfoqq -L $tableid -U $tableid
sleep 36s
