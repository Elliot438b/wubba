...
CONTRACT gameroulette : public contract
{
  public:
    using contract::contract;

    gameroulette(name receiver, name code, datastream<const char *> ds)
    ...
    typedef eosio::multi_index<"tablesinfo"_n, gameroulette::table_stats, indexed_by<"dealer"_n, const_mem_fun<gameroulette::table_stats, uint64_t, &gameroulette::table_stats::get_dealer>>> singletable_t;
    // std random
    struct WBRNG
    {
        unsigned long next;
    ...
    using newtable_action = action_wrapper<"newtable"_n, &gameroulette::newtable>;
    using dealerseed_action = action_wrapper<"dealerseed"_n, &gameroulette::dealerseed>;
    using serverseed_action = action_wrapper<"serverseed"_n, &gameroulette::serverseed>;
    using playerbet_action = action_wrapper<"playerbet"_n, &gameroulette::playerbet>;
    using endbet_action = action_wrapper<"endbet"_n, &gameroulette::endbet>;
    using verdealeseed_action = action_wrapper<"verdealeseed"_n, &gameroulette::verdealeseed>;
    using verserveseed_action = action_wrapper<"verserveseed"_n, &gameroulette::verserveseed>;
    using trusteeship_action = action_wrapper<"trusteeship"_n, &gameroulette::trusteeship>;
    using exitruteship_action = action_wrapper<"exitruteship"_n, &gameroulette::exitruteship>;
    using disconnecthi_action = action_wrapper<"disconnecthi"_n, &gameroulette::disconnecthi>;
    using erasingdata_action = action_wrapper<"erasingdata"_n, &gameroulette::erasingdata>;
    using pausetabledea_action = action_wrapper<"pausetabledea"_n, &gameroulette::pausetabledea>;
    using pausetableser_action = action_wrapper<"pausetablesee"_n, &gameroulette::pausetablesee>;
    using continuetable_action = action_wrapper<"continuetable"_n, &gameroulette::continuetable>;
    using closetable_action = action_wrapper<"closetable"_n, &gameroulette::closetable>;
    using depositable_action = action_wrapper<"depositable"_n, &gameroulette::depositable>;
    using dealerwitdaw_action = action_wrapper<"dealerwitdaw"_n, &gameroulette::dealerwitdaw>;
    using changeprivat_action = action_wrapper<"changeprivat"_n, &gameroulette::changeprivat>;
