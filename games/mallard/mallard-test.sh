...
temptest)
    ...
    cleos --wallet-url http://127.0.0.1:6666 push action gamemallards newtable '[useraaaaaaab,"23000.0000 TES", 1,"useraaaaaaaj","TES", "1001.0000 TES","100.0000 TES","100.0000 TES","1.0000 TES","50.0000 TES","1.0000 TES"]' -p useraaaaaaab
    ...
    cleos --wallet-url http://127.0.0.1:6666 push action gamemallards playerbet '['$tableid',useraaaaaaac,"0.0000 TES","200.0000 TES","3.0000 TES","4.0000 TES","3.0000 TES"]' -p useraaaaaaac useraaaaaaah
    cleos --wallet-url http://127.0.0.1:6666 push action gamemallards playerbet '['$tableid',useraaaaaaad,"0.0000 TES","100.0000 TES","0.0000 TES","10.0000 TES","10.0000 TES"]' -p useraaaaaaad useraaaaaaah
    cleos get table gamemallards gamemallards tablesinfo -L $tableid -U $tableid
    sleep 36s
